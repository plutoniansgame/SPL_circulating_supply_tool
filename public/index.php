...
if (!isset($_GET["max"]) && !isset($_GET["supply"])) {
	echo "max supply PLD: https://https://supply.pluto.quest?max=pld\nmax supply RPC: https://https://supply.pluto.quest?max=pld\ncirculating PLD: https://https://supply.pluto.quest?supply=pld\ncirculating RPC: https://https://supply.pluto.quest?supply=rpc";
} else {
	

	if ( isset($_GET["max"]) && $_GET["max"] == 'rpc' ) {
		echo '35000000000.00';
	} else if ( isset($_GET["max"]) && $_GET["max"] == 'pld' ) {
		echo '350000000.00';
	} else {
